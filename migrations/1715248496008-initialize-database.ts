...
export class InitializeDatabase1715248496008 implements MigrationInterface {
    name = 'InitializeDatabase1715248496008'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."Users_role_enum" AS ENUM('user', 'admin', 'merchant', 'moderator')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."Products_status_enum" AS ENUM('available', 'reserved', 'sold', 'moderating')`);
